...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct PlayerHeroPathCompBin {
    #[prost(int32, tag = "1")]
    pub cur_mc_path: i32,
    #[prost(int32, tag = "2")]
    pub cur_march_path: i32,
    #[prost(message, repeated, tag = "3")]
    pub multipath_type_list: ::prost::alloc::vec::Vec<HeroPathTypeBin>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct PlayerDataBin {
    ...
    pub multipath_bin: ::core::option::Option<PlayerHeroPathCompBin>,
}
